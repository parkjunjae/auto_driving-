...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'config_file',                  'default': "/home/world/to_ws/config/realsense.yaml", 'description': 'yaml config file'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '848x480x30', 'description': 'color stream profile'},
